...
public class OperatorProb {
    public static void main(String[] args) {
        ...
        double divResult = 0.0; // 이 부분을 수정하세요.
        System.out.println("10 / 3 결과 (실수): " + divResult); // 3.3333333333333335

        // [문제 1-2] 변수 a를 b로 나눈 '나머지'를 구하여 출력하세요.
        int modResult = 0; // 이 부분을 수정하세요.
        System.out.println("10을 3으로 나눈 나머지: " + modResult); // 1
        ...
        boolean isLeapYear = false; // 이 부분을 수정하세요.
